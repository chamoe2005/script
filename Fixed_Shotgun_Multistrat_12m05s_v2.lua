...
getgenv().Maps = {["Crystal Cave"] = {"Farm", "Commander", "Soldier", "Shotgunner", "DJ Booth"},["Night Station"] = {"Farm", "Commander", "Soldier", "Shotgunner", "DJ Booth"},["Winter Abyss"] = {"Farm", "Commander", "Soldier", "Shotgunner", "DJ Booth"}}--Enter the correct info. Map, then units. If no unit in slot, write, "nil" Follow format to add more maps
maplist = {"Crystal Cave","Night Station","Winter Abyss"}
...
TDS:Loadout("Farm", "Commander", "Soldier", "Shotgunner", "DJ Booth") 
...
TDS:AutoChain(20, 17, 18, 19, 0, 56)--AUTO CTA
